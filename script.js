...
class TableGenerator {
    ...
    display() {
        ...
        for (let v = 0; v < dataProps.length; v++) {
            ...
            for(let z = 0; z < Object.keys(this.data[0]).length; z++) {
                var td = document.createElement('td');
                
                var tds=document.querySelectorAll('td')
            
                for (var i=-1 ; i<tds.length; i++) {  //Если не начинать с -1, при нажатии на первую тдшку (Luke Skywalker) инпут не генерируется
                    td.onclick = function() {
                        ...
                        input.onblur = function() {
                            ...
                            var origin_text=input.parentElement.getAttribute('data-text');
                            ...
                            if (origin_text != current_text) {
                                ...
                                console.log(origin_text +' is changed to ' + current_text)
                            }
                        }
                    }
                }
